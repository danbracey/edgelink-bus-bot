...
$discord->on(Event::INTERACTION_CREATE, function ( Interaction $interaction, Discord $discord) use ($config) {
    if($interaction["data"]["name"] === "bus") {
        try {
            ...
            if(! $BusData['ServiceDelivery']["VehicleMonitoringDelivery"]["VehicleActivity"][0]) {
                ...
                $lat = $BusData['ServiceDelivery']["VehicleMonitoringDelivery"]["VehicleActivity"][0]["MonitoredVehicleJourney"]["VehicleLocation"]["Latitude"];
                $long = $BusData['ServiceDelivery']["VehicleMonitoringDelivery"]["VehicleActivity"][0]["MonitoredVehicleJourney"]["VehicleLocation"]["Longitude"];
                ...
                $embed->addField([
                    ...
                    'value' => $BusData['ServiceDelivery']["VehicleMonitoringDelivery"]["VehicleActivity"][0]["MonitoredVehicleJourney"]["OperatorRef"]
                ]);
                $embed->addField([
                ...
                $embed->addField([
                    ...
                    'value' => $BusData['ServiceDelivery']["VehicleMonitoringDelivery"]["VehicleActivity"][0]["MonitoredVehicleJourney"]["VehicleRef"]
                ]);
                $embed->addField([
                    'name' => 'Driver: ',
                    'value' => $BusData['ServiceDelivery']["VehicleMonitoringDelivery"]["VehicleActivity"][0]["Extensions"]["VehicleJourney"]["DriverRef"]
                ]);
